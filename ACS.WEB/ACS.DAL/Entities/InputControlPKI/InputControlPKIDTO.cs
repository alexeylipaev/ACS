...
{
    public class InputControlPKI: SystemParameters
    {
        public InputControlPKI()
        {
            ReceivedDoc = new HashSet<ReceivedDocPKI>();
        }
        /// <summary>
        /// ID
        /// </summary>
        ...
        /// </summary>
        ICollection<ReceivedDocPKI> ReceivedDoc { get; set; }
